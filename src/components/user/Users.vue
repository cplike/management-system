  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="姓名" prop="username"></el-table-column>scope.row.mg_state
    ...
    <!-- 修改用户信息的对话框 -->
    <el-dialog title="修改信息" :visible.sync="aditDialogVisible" width="50%" @close="editDialogClosed">
